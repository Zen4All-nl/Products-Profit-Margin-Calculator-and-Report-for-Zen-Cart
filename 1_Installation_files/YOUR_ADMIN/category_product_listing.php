            ...
            <thead>
              <tr>
                ...
                <?php if ($show_prod_labels) { ?>
                  ...
                  <th class="hidden-sm hidden-xs"><?php echo TABLE_HEADING_COST; ?></th>
