...
$module_constant = 'PROFIT_MARGIN_VERSION';
$module_installer_directory = DIR_FS_ADMIN . 'includes/installers/profit_margin';
$module_name = "Profit Margin Calculator"; 
$zencart_com_plugin_id = 175;
