 ...
 */
  ...
  if (isset($_POST['edit_x']) || isset($_POST['edit_y'])) {
    ...
    $sql_data_array = array('products_quantity' => $products_quantity,
			    ...
			    'products_cost' => zen_db_prepare_input($_POST['products_cost']),
                            'products_markup' => zen_db_prepare_input($_POST['products_markup']),
			    'products_margin_gross_dollar' => zen_db_prepare_input($_POST['products_margin_gross_dollar']),
                            'products_margin_gross_percent' => zen_db_prepare_input($_POST['products_margin_gross_percent']),
