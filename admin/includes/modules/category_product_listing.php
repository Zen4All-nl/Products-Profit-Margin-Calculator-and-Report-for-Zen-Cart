...
<?php if ($action == '') { ?>
		...
		<td class="dataTableHeadingContent" width="20" align="left"><?php echo TABLE_HEADING_COST; ?></td>
...
/*
      $products_query_raw = ("select p.products_type, p.products_id, pd.products_name, p.products_quantity,
                                       p.products_image, p.products_price, p.products_cost,p.products_markup,p.products_date_added,
...
?>
		...
		<td class="dataTableContent"  width="70"align="center"><?php echo zen_get_products_display_cost($products->fields['products_id']); ?></td>
