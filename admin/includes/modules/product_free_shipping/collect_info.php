 ...
 * Added Profit Margin Calculator v1.2
 */
if (!defined('IS_ADMIN_FLAG')) {
  die('Illegal Access');
    ...
    $parameters = array('products_name' => '',
                       ...
                       'products_cost' => '',
                       'products_markup' => '',
                       'products_margin_gross_dollar' => '',
                       'products_margin_gross_percent' => '',
...
// BOF Profit Margin Calculator Functions
function updateCost() {
	
  var costValue = document.forms["new_product"].products_cost.value;

  document.forms["new_product"].products_cost.value  = doRound(costValue,4);
}
...
function updateMarkup() {
  ...
  var markupValue = document.forms["new_product"].products_markup.value;
  var costValue = document.forms["new_product"].products_cost.value;
   
  var costValue = Number(costValue);
  var markupValue = Number(markupValue);
    
  var markup = costValue + ((costValue * markupValue)/100);
  
  document.forms["new_product"].products_price.value =  doRound(markup,4);
...
function updatemarginGrossDollar() {
	  ...
	  var netValue = document.forms["new_product"].products_price.value
	    ...
	    var costValue = Number(costValue);
	    var netValue = Number(netValue);
	    
	    var marginGrossDollar = netValue - costValue;
  
  document.forms["new_product"].products_margin_gross_dollar.value  = doRound(marginGrossDollar,4);
}


function updatemarginGrossPercent() {
	
  var marginGrossDollarValue = document.forms["new_product"].products_margin_gross_dollar.value;
  var netValue = document.forms["new_product"].products_price.value
  
  var marginGrossDollarValue = Number(marginGrossDollarValue);
  var netValue = Number(netValue);
  
  	    var marginGrossPercent = (marginGrossDollarValue / netValue) * 100;

  document.forms["new_product"].products_margin_gross_percent.value  = doRound(marginGrossPercent,4);
}
// EOF Profit Margin Calculator functions
...
?>
          ...
          <tr bgcolor="#ebebff">
           ...
           <tr>
            <td class="main"><?php echo TEXT_PRODUCTS_PRICE_MARGIN_CALCULATOR; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '1', '10'); ?></td>
          </tr>
          <tr>
           <tr bgcolor="#f7f6ef">
            <td class="main"><?php echo TEXT_PRODUCTS_PRICE_COST; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_cost', $pInfo->products_cost, 'OnKeyUp="updateNet()"'); ?></td>
           </tr>
          </tr> 
          <tr>
           <tr bgcolor="#f7f6ef">
            <td class="main"><?php echo TEXT_PRODUCTS_PRICE_MARKUP; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_markup', $pInfo->products_markup, 'OnKeyUp="updateMarkup()"') . ' %'; ?></td>
           </tr>
          </tr> 
          <tr>
           <tr bgcolor="#f0f1f1">
            <td class="main"><?php echo TEXT_PRODUCTS_PRICE_MARGIN_GROSS; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_margin_gross_dollar', $pInfo->products_margin_gross_dollar, 'OnKeyUp="updatemarginGrossDollar()"'); ?></td>
           </tr>
          </tr>
          <tr>
           <tr bgcolor="#f0f1f1">
            <td class="main"><?php echo TEXT_PRODUCTS_PRICE_MARGIN_GROSS_PERCENT; ?></td>
            <td class="main"><?php echo zen_draw_separator('pixel_trans.gif', '24', '15') . '&nbsp;' . zen_draw_input_field('products_margin_gross_percent', $pInfo->products_margin_gross_percent, 'OnKeyUp="updatemarginGrossPercent()"') . ' %'; ?></td>
           </tr>
