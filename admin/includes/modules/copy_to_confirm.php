...
// Copy attributes to duplicate product
          ...
          if ($_POST['copy_as'] == 'link') {
            ...
            $product = $db->Execute("select products_type, products_quantity, products_model, products_image,
                                            products_price, products_cost, products_markup, products_margin_gross_dollar, products_margin_gross_percent, products_virtual, products_date_available, products_weight,
            ...
            $db->Execute("insert into " . TABLE_PRODUCTS . "
                                      (products_type, products_quantity, products_model, products_image,
                                       products_price, products_cost, products_markup, products_margin_gross_dollar, products_margin_gross_percent, products_virtual, products_date_added, products_date_available,
                          ...
                          values ('" . zen_db_input($product->fields['products_type']) . "',
                                  ...
                                  '" . $products_price . "',
				'" . zen_db_input($product->fields['products_cost']) . "',
								  '" . zen_db_input($product->fields['products_markup']) . "',
								  '" . zen_db_input($product->fields['products_margin_gross_dollar']) . "',
								  '" . zen_db_input($product->fields['products_margin_gross_percent']) . "',
